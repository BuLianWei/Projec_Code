package com.example.asus.myapplication.utils.coin;
...
public class TossImageView extends ImageView {
     ...
     * 抛硬币的回调函数
     */
    private com.example.asus.myapplication.utils.coin.TossAnimation.TossAnimationListener mTossAnimationListener;
     ...
     * @return
     */
    public TossImageView setTossAnimationListener(com.example.asus.myapplication.utils.coin.TossAnimation.TossAnimationListener tossAnimationListener) {
    ...
    public void startToss() {
        ...
        com.example.asus.myapplication.utils.coin.TossAnimation tossAnimation = new com.example.asus.myapplication.utils.coin.TossAnimation(mCircleCount, mXAxisDirection, mYAxisDirection, mZAxisDirection, mResult);
     ...
     * 可以改变ImageView的监听器
     */
    public class QTTossAnimationListener implements com.example.asus.myapplication.utils.coin.TossAnimation.TossAnimationListener {

        private com.example.asus.myapplication.utils.coin.TossAnimation.TossAnimationListener mTossAnimationListener;

        public QTTossAnimationListener(com.example.asus.myapplication.utils.coin.TossAnimation.TossAnimationListener tossAnimationListener) {
            mTossAnimationListener = tossAnimationListener;
        }

        @Override
        public void onDrawableChange(int result, com.example.asus.myapplication.utils.coin.TossAnimation animation) {
            switch (result) {
                case com.example.asus.myapplication.utils.coin.TossAnimation.RESULT_FRONT:
                    setImageDrawable(mFrontDrawable);
                    break;
                case com.example.asus.myapplication.utils.coin.TossAnimation.RESULT_REVERSE:
